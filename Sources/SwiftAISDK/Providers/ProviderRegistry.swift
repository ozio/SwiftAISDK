...
public enum AIProviders {
    ...
    public static func openAICompatible(
        ...
        try OpenAICompatibleProvider(
            ...
            userAgentSuffix: "ai-sdk/openai-compatible/3.0.48",
    ...
    public static func openResponses(name: String, url: String, settings: ProviderSettings = ProviderSettings()) throws -> OpenAICompatibleProvider {
        ...
        headers = withUserAgentSuffix(headers, "ai-sdk/open-responses/2.0.44")
    ...
    public static func blackForestLabs(settings: ProviderSettings = ProviderSettings()) throws -> OpenAICompatibleProvider {
        try OpenAICompatibleProvider(providerID: "black-forest-labs", defaultBaseURL: "https://api.bfl.ai/v1", authorization: .apiKeyHeader(name: "x-key", environmentVariables: ["BFL_API_KEY", "BLACK_FOREST_LABS_API_KEY"]), supportedCapabilities: [.image, .video], settings: settings)
    }
...
private func perplexityHeaders(settings: ProviderSettings) throws -> [String: String] {
    ...
    return withUserAgentSuffix(headers, "ai-sdk/perplexity/4.0.43")
}

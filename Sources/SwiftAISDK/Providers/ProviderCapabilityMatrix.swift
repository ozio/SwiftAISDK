...
public enum AIProviderCapabilities {
    ...
    public static let all: [AIProviderCapabilityRow] = [
        ...
        providerRow("baseten", "@ai-sdk/baseten", ["AIProviders.baseten"], [.language, .embedding], notes: "`ProviderSettings.modelURL` selects dedicated Baseten endpoints: chat uses `/sync/v1`, rejects `/predict`, and falls back to the Model API for plain `/sync`, while embeddings require `/sync` or `/sync/v1` and mirror the upstream performance-client body plus 128-input batching."),
        providerRow("black-forest-labs", "@ai-sdk/black-forest-labs", ["AIProviders.blackForestLabs"], [.image]),
        providerRow("bytedance", "@ai-sdk/bytedance", ["AIProviders.byteDance"], [.video]),
        ...
        providerRow("deepinfra", "@ai-sdk/deepinfra", ["AIProviders.deepInfra"], [.language, .completion, .embedding, .image]),
        providerRow("deepseek", "@ai-sdk/deepseek", ["AIProviders.deepSeek"], [.language]),
        providerRow("elevenlabs", "@ai-sdk/elevenlabs", ["AIProviders.elevenLabs"], [.transcription, .speech, .audioGeneration, .audioTransformation, .dubbing]),
        ...
        providerRow("huggingface", "@ai-sdk/huggingface", ["AIProviders.huggingFace"], [.language]),
        providerRow("hume", "@ai-sdk/hume", ["AIProviders.hume"], [.speech]),
        providerRow("klingai", "@ai-sdk/klingai", ["AIProviders.klingAI"], [.video]),
        ...
        providerRow("moonshotai", "@ai-sdk/moonshotai", ["AIProviders.moonshotAI"], [.language], notes: "Chat requests stream usage by default and maps `providerOptions.moonshotai` thinking/reasoningHistory through the upstream option schema."),
        ...
        providerRow("quiverai", "@ai-sdk/quiverai", ["AIProviders.quiverAI"], [.image]),
        providerRow("replicate", "@ai-sdk/replicate", ["AIProviders.replicate"], [.image, .video]),
        providerRow("revai", "@ai-sdk/revai", ["AIProviders.revAI"], [.transcription]),
        providerRow("togetherai", "@ai-sdk/togetherai", ["AIProviders.togetherAI"], [.language, .completion, .embedding, .image, .reranking], notes: "Image generation mirrors upstream `maxImagesPerCall = 1`; image and reranking responses are validated against the upstream-focused JSON shapes."),
        ...
        providerRow("xai", "@ai-sdk/xai", ["AIProviders.xAI"], [.language, .image, .video], files: true)
    ]

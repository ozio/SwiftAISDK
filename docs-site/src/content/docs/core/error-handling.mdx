...
- `AINoSuchToolError`, `AIInvalidToolInputError`, `AIToolCallRepairError`, `AIInvalidToolApprovalError`, and `AIToolCallNotFoundForApprovalError` for tool execution and approval flows.

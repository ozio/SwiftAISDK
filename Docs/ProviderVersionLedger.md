...
Versions below were checked with `npm view <package> version` on 2026-06-23.
...
| `@ai-sdk/anthropic` | `3.0.85` | `AIProviders.anthropic`, `AnthropicLanguageModel`, `AnthropicTools`, `AnthropicTests.swift` |
| `@ai-sdk/anthropic-aws` | `1.0.7` | `AIProviders.anthropicAWS`, `AnthropicAWSProvider`, `AnthropicTests.swift` |

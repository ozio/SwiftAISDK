...
| Kling, ByteDance | `klingai`, `bytedance` | Provider-specific video models outside the OpenAI-compatible chat family. | `ImageVideoProviderTests.swift`, `NativeMediaProviderTests.swift`, `ProviderAbortPropagationTests.swift` |

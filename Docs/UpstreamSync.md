...
| Prodia, Quiver, Luma, Kling, ByteDance | `prodia`, `quiverai`, `luma`, `klingai`, `bytedance` | Provider-specific language/media/video models outside the OpenAI-compatible chat family. | `AlibabaProdiaAzureQuiverTests.swift`, `ImageVideoProviderTests.swift`, `NativeMediaProviderTests.swift`, `ProviderAbortPropagationTests.swift` |

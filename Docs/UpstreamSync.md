...
| ByteDance | `bytedance` | Provider-specific video model outside the OpenAI-compatible chat family. | `ImageVideoProviderTests.swift`, `NativeMediaProviderTests.swift`, `ProviderAbortPropagationTests.swift` |

...
| Luma, Kling, ByteDance | `luma`, `klingai`, `bytedance` | Provider-specific media/video models outside the OpenAI-compatible chat family. | `AlibabaProdiaAzureQuiverTests.swift`, `ImageVideoProviderTests.swift`, `NativeMediaProviderTests.swift`, `ProviderAbortPropagationTests.swift` |

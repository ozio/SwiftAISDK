...
| AI facade | `AI.generateText`, `AI.streamText`, `AI.embed`, `AI.embedMany`, `AI.generateImage`, `AI.transcribe`, `AI.generateSpeech`, `AI.generateVideo`, `AI.rerank`, `AI.uploadFile`, and `AI.uploadSkill` are thin product-level wrappers over the model/client protocols. Retry, tool-loop, object-generation, and telemetry behavior are still follow-up product passes. |

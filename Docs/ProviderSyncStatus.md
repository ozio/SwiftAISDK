...
Reopen only if: alibaba npm version changes, Qwen chat/error/usage schemas change, embedding native API schema changes, Wan video native API schema changes, providerOptions schemas change, live smoke or user bug reports a concrete mismatch.
```

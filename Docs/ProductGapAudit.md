...
live verification, and user-facing workflows are uneven across the large surface
area.
...
3. **Provider option examples round.**
...
5. **Scope decision round for UI streams and agents.**

...
@Test func amazonBedrockAppendsVersionedUserAgentToCustomHeaders() async throws {
    ...
    #expect(converseRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.58")
    #expect(anthropicRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.58")
    #expect(mantleRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.58")
}

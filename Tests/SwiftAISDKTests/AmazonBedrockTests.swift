...
@Test func amazonBedrockConverseUsesSigV4AndConverseShape() async throws {
    ...
    #expect(request.headers["user-agent"] == "ai-sdk/amazon-bedrock/5.0.17")
...
@Test func amazonBedrockAppendsVersionedUserAgentToCustomHeaders() async throws {
    ...
    #expect(converseRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.17")
    #expect(anthropicRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.17")
    #expect(mantleRequest.headers["user-agent"] == "CustomApp/1.0 ai-sdk/amazon-bedrock/5.0.17")
}

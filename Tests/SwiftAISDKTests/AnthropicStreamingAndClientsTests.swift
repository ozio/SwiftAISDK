...
@Test func anthropicFilesUploadAddsBetaHeader() async throws {
    ...
    #expect(request.headers["user-agent"] == "ai-sdk/anthropic/4.0.58")
...
@Test func anthropicSkillsUploadAddsBetaHeaderAndFetchesVersionMetadata() async throws {
    ...
    #expect(requests[0].headers["user-agent"] == "ai-sdk/anthropic/4.0.58")
    ...
    #expect(requests[1].headers["user-agent"] == "ai-sdk/anthropic/4.0.58")
}

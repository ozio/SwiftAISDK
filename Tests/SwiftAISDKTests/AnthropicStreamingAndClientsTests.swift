...
@Test func anthropicSkillsUploadAddsBetaHeaderAndFetchesVersionMetadata() async throws {
    ...
    #expect(requests[0].headers["user-agent"] == "ai-sdk/anthropic/4.0.26")
    ...
    #expect(requests[1].headers["user-agent"] == "ai-sdk/anthropic/4.0.26")
}

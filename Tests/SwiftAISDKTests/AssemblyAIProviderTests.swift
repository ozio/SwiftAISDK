...
@Test func assemblyAITranscriptionUploadsSubmitsAndPolls() async throws {
    ...
    #expect(requests[0].headers["user-agent"] == "ai-sdk/assemblyai/3.0.45")
    ...
    #expect(requests[1].headers["user-agent"] == "ai-sdk/assemblyai/3.0.45")
    ...
    #expect(requests[2].headers["user-agent"] == "ai-sdk/assemblyai/3.0.45")

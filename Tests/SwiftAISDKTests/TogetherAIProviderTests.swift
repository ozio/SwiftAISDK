...
@Test func togetherAIImageAndRerankingUseNativeEndpoints() async throws {
    ...
    #expect(imageRequest.headers["user-agent"] == "ai-sdk/togetherai/3.0.8")
    ...
    #expect(rerankRequest.headers["user-agent"] == "ai-sdk/togetherai/3.0.8")
...
@Test func togetherAIAppendsVersionedUserAgentToCustomHeader() async throws {
    ...
    #expect(request.headers["user-agent"] == "CustomApp/1.0 ai-sdk/togetherai/3.0.8")
}

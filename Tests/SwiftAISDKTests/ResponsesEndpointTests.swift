...
@Test func basetenChatRejectsPredictAndPlainSyncModelURLs() throws {
    ...
    let syncProvider = try AIProviders.baseten(settings: ProviderSettings(
        apiKey: "baseten-key",

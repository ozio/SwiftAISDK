...
@Test func xAISpeechAndTranscriptionUseNativeAudioEndpoints() async throws {
    ...
    #expect(speechRequest.headers["user-agent"] == "ai-sdk/xai/4.0.25")
    ...
    #expect(transcriptionRequest.headers["user-agent"] == "ai-sdk/xai/4.0.25")
...
@Test func xAIImageAndVideoUseNativeEndpoints() async throws {
    ...
    #expect(imageRequest.headers["user-agent"] == "ai-sdk/xai/4.0.25")
    ...
    #expect(requests[0].headers["user-agent"] == "ai-sdk/xai/4.0.25")
    ...
    #expect(requests[1].headers["user-agent"] == "ai-sdk/xai/4.0.25")
    ...
    #expect(editRequests[0].headers["user-agent"] == "ai-sdk/xai/4.0.25")
    #expect(editRequests[1].headers["authorization"] == "Bearer xai-key")
    #expect(editRequests[1].headers["user-agent"] == "ai-sdk/xai/4.0.25")
